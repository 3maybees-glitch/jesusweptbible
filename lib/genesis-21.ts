...
export const genesisChapter21: ChapterData = {
  "Genesis-21": {
    book: "Genesis",
    chapter: 21,
    twoWordSummary: "Promised Birth",
    themeSummary: "God fulfills His promise with Isaac's birth, preserves Hagar and Ishmael in the wilderness, and confirms a covenant with Abimelech at Beersheba.",
    sentenceDescription: "Isaac is born to Abraham and Sarah in their old age; Ishmael is cast out but God preserves him; Abraham makes a covenant with Abimelech.",
    themeWords: [
      { word: "Isaac", strongNumber: "H3327", language: "Hebrew", lemma: "Yitschaq", meaning: "he laughs" },
      { word: "Covenant", strongNumber: "H1285", language: "Hebrew", lemma: "beriyth", meaning: "a pact, treaty, or alliance" }
    ],
    verses: [
      {
        verse: 1,
        ...
        highlightedWords: [
          { word: "LORD", strongNumber: "H3068", lemma: "YHWH", meaning: "the personal name of the God of Israel; Yahweh/Jehovah" },
          { word: "Sarah", strongNumber: "H8283", lemma: "Sarah", meaning: "princess; noblewoman" }
        ]
      },
      {
        verse: 2,
        ...
        highlightedWords: [
          { word: "Sarah", strongNumber: "H8283", lemma: "Sarah", meaning: "princess; noblewoman" },
          { word: "God", strongNumber: "H430", lemma: "Elohim", meaning: "God; the true God; mighty one" }
        ]
      },
      {
        verse: 3,
        ...
        highlightedWords: [
          { word: "Abraham", strongNumber: "H85", lemma: "Avraham", meaning: "father of a multitude" },
          { word: "Isaac", strongNumber: "H3327", lemma: "Yitschaq", meaning: "he laughs" }
        ]
      },
      {
        verse: 4,
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "Sarah", strongNumber: "H8283", lemma: "Sarah", meaning: "princess; noblewoman" },
          { word: "Hagar", strongNumber: "H1904", lemma: "Hagar", meaning: "flight; a woman's name" }
        ]
      },
      {
        verse: 10,
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "son", strongNumber: "H1121", lemma: "ben", meaning: "son; child; descendant" },
          { word: "sight", strongNumber: "H5869", lemma: "ayin", meaning: "eye; appearance; sight" }
        ]
      },
      {
        verse: 12,
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "nation", strongNumber: "H1471", lemma: "goy", meaning: "nation; people; Gentiles" },
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "water", strongNumber: "H4325", lemma: "mayim", meaning: "water; waters" },
          { word: "child", strongNumber: "H3206", lemma: "yeled", meaning: "child; boy; youth" }
        ]
      },
      {
        verse: 16,
        ...
        highlightedWords: [
          { word: "voice", strongNumber: "H6963", lemma: "qol", meaning: "voice; sound; call" },
          { word: "child", strongNumber: "H3206", lemma: "yeled", meaning: "child; boy; youth" }
        ]
      },
      {
        ...
        highlightedWords: [
          { word: "God", strongNumber: "H430", lemma: "Elohim", meaning: "God; the true God; mighty one" },
          { word: "angel", strongNumber: "H4397", lemma: "mal'ak", meaning: "messenger; angel" }
        ]
      },
      {
        verse: 18,
        ...
        highlightedWords: [
          { word: "lad", strongNumber: "H5288", lemma: "na'ar", meaning: "boy; youth; servant" },
          { word: "nation", strongNumber: "H1471", lemma: "goy", meaning: "nation; people; Gentiles" }
        ]
      },
      {
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "Paran", strongNumber: "H6290", lemma: "Paran", meaning: "Paran; a desert region" },
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "Abimelech", strongNumber: "H40", lemma: "Abimelek", meaning: "my father is king; a Philistine royal name" },
          { word: "God", strongNumber: "H430", lemma: "Elohim", meaning: "God; the true God; mighty one" }
        ]
      },
      {
        ...
        highlightedWords: [
          { word: "swear", strongNumber: "H7650", lemma: "shaba'", meaning: "to swear; to take an oath" },
          { word: "God", strongNumber: "H430", lemma: "Elohim", meaning: "God; the true God; mighty one" }
        ]
      },
      {
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "Abraham", strongNumber: "H85", lemma: "Avraham", meaning: "father of a multitude" },
          { word: "well", strongNumber: "H875", lemma: "be'er", meaning: "a well; pit; spring" }
        ]
      },
      {
        verse: 26,
        ...
        highlightedWords: [
          { word: "Abimelech", strongNumber: "H40", lemma: "Abimelek", meaning: "my father is king; a Philistine royal name" },
          { word: "day", strongNumber: "H3117", lemma: "yom", meaning: "day; time; period" }
        ]
      },
      {
        verse: 27,
        ...
        highlightedWords: [
          { word: "Abimelech", strongNumber: "H40", lemma: "Abimelek", meaning: "my father is king; a Philistine royal name" },
          { word: "covenant", strongNumber: "H1285", lemma: "beriyth", meaning: "covenant; alliance; pledge" }
        ]
      },
      {
        verse: 28,
        ...
        highlightedWords: [
          { word: "Abraham", strongNumber: "H85", lemma: "Avraham", meaning: "father of a multitude" },
          { word: "seven", strongNumber: "H7651", lemma: "sheba'", meaning: "seven" }
        ]
      },
      {
        verse: 29,
      ...
      },
      {
        ...
        highlightedWords: [
          { word: "witness", strongNumber: "H5707", lemma: "'ed", meaning: "witness; testimony; evidence" },
          { word: "well", strongNumber: "H875", lemma: "be'er", meaning: "a well; pit; spring" }
        ]
      },
      {
        ...
        highlightedWords: [
          { word: "Beersheba", strongNumber: "H884", lemma: "Be'er Sheba'", meaning: "well of seven/oath; place in the Negev" },
          { word: "sware", strongNumber: "H7650", lemma: "shaba'", meaning: "to swear; to take an oath" }
        ]
      },
      {
        verse: 32,
        ...
        highlightedWords: [
          { word: "covenant", strongNumber: "H1285", lemma: "beriyth", meaning: "covenant; alliance; pledge" },
          { word: "Philistines", strongNumber: "H6430", lemma: "Pelishtiy", meaning: "Philistines; people of Philistia" }
        ]
      },
      {
        verse: 33,
        ...
        highlightedWords: [
          { word: "LORD", strongNumber: "H3068", lemma: "YHWH", meaning: "the personal name of the God of Israel; Yahweh/Jehovah" },
          { word: "everlasting", strongNumber: "H5769", lemma: "'olam", meaning: "everlasting; perpetual; eternity" }
        ]
      },
      {
        verse: 34,
        ...
        highlightedWords: [
          { word: "sojourned", strongNumber: "H1481", lemma: "gur", meaning: "to sojourn; dwell as a foreigner" },
          { word: "Philistines'", strongNumber: "H6430", lemma: "Pelishtiy", meaning: "Philistines; people of Philistia" }
        ]
      }
    ]
